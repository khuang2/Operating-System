...
void test1b(void) {
	...
	// Try to create a process with an illegal priority.      PUT THEM IN THE READY QUEUE
	printf("This is Release %s:  Test 1b\n", CURRENT_REL);
	CREATE_PROCESS("test1b_a", test1x, ILLEGAL_PRIORITY, &ProcessID1,
			&ErrorReturned);
	printf("*1***,ErrorExpected*");
...
void test2a(void) {
	...
	long DataRead;
	long ErrorReturned;
	//void* PageTable = (void *) calloc(25, VIRTUAL_MEM_PAGES);
	GET_PROCESS_ID("", &OurProcessID, &ErrorReturned);
